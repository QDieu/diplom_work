...
void forcesCalc_mpi(std::vector<Point>& points, std::vector<Point>& resPoints, const int partSize, const int rank, const int dt, int& size){
...
void worker(int rank){
	...
	while(1){
		...
		forcesCalc_mpi(points, resPoints, partSize, rank, dt, size);
